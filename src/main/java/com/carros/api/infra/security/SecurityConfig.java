...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and().csrf().disable()
                .addFilter(new JwtAuthenticationFilter(authManager))//faz o login e gera o token
                .addFilter(new JwtAuthorizationFilter(authManager, userDetailsService))//pega o token e vê se é válido
                .exceptionHandling()
